...
import { Title, SubTitle, Image, Container, List, Paragraph } from "./InfoStyled";
    ...
    <div className="container mb-3" id="infos">
      <div className="row">
        ...
        <animated.div style={slideUp}>
          <Container>
            <div className="col-sm-12 col-md-12 d-flex justify-content-center col-lg-6 col-xl-5">
              <Image
            ...
            <div className="col-sm-12 col-md-12 col-lg-6 col-xl-7 pt-5">
